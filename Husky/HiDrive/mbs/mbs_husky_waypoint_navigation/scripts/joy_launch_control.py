...
def getPaths():
    ...
    # global move_base_node
    rospack = rospkg.RosPack()
    
    location_collect = rospack.get_path('mbs_husky_waypoint_navigation') + "/launch/include/collect_waypoints.launch"
    location_send = rospack.get_path('mbs_husky_waypoint_navigation') + "/launch/include/send_goals.launch"
    location_calibrate = rospack.get_path('mbs_husky_waypoint_navigation') + "/launch/include/heading_calibration.launch"
    location_safety_node = rospack.get_path('mbs_husky_waypoint_navigation') + "/launch/include/safety_node.launch"
    # move_base_node = rospack.get_path('mbs_husky_waypoint_navigation') + "/launch/waypoint_husky_movebase.launch"
